...
This is a Mini-Project for SC1015 (Introduction to Data Science and Artificial Intelligence) which focuses on the English Premier League Dataset. For detailed walkthrough, we recommend that you go through the our full project notebook, which will guide you through our project:

[Full Project](https://github.com/SyedZaheen/Beautiful-Data-For-Beautiful-Game/blob/main/FullProject.ipynb)

For quicker navigation, you can click on on the following links to have a quick look at divided chunks of our notebook: 
...
- How to calculate feature importance for multivariate linear regression and random forest classifier
