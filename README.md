...
However, our findings showed that, unsurprisingly, number of shots on target predicts number of goals scored the best, and by a large margin too. Thus, our recommendation is to take more shots in order to score more goals - which is pretty obvious and uninteresting. Since our problem had such an easy answer, we decided to refine our problem. 
